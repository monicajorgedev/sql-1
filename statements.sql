...
-- Tu respuesta aquí
SELECT COUNT(*) FROM uuarios_lenguajes WHERE lenguaje = 'JavaScript';
...
-- Tu respuesta aquí
SELECT lenguaje, COUNT(*) AS num_usuarios FROM usuarios_lenguajes WHERE edad < 30 GROUP BY lenguaje ORDER BY num_usuarios DESC LIMIT 1;
...
-- Tu respuesta aquí
SELECT nombre, apellido, COUNT(lenguaje) FROM usuarios_lenguajes WHERE lenguaje IS NOT NULL GROUP BY nombre, apellido;

-- Ejercicio 22: Encontrar el lenguaje con más caracteres.
-- Tu respuesta aquí
SELECT lenguaje FROM usuarios_lenguajes WHERE LENGTH(lenguaje) = (SELECT MAX(LENGTH(lenguaje)) FROM usuarios_lenguajes) LIMIT 1;
...
-- Tu respuesta aquí
SELECT * FROM usuarios_lenguajes WHERE lenguaje NOT <> 'SQL';
...
-- Tu respuesta aquí
SELECT nombre, CHAR_LENGTH(nombre) FROM usuarios_lenguajes WHERE lenguaje IS NOT NULL;
